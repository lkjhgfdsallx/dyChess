export default class staminaBtn {
    ...
    draw() {
        ...
        ctx.fillText(
            ...
            canvas.height * 0.076 + (staminaWidth - setFontSize) * 0.3
        ) // 文字内容、位置
    }
    ...
    drawToCanvas(ctx) {
        ...
        ctx.drawImage(this.staminaIcon, canvas.width - staminaWidth - this.centreX + 5, canvas.height * 0.076, staminaWidth, staminaHeight)
        ctx.drawImage(this.staminaIcon2, canvas.width - staminaWidth - this.centreX, canvas.height * 0.074, staminaHeight, staminaHeight * 1.49)
        ctx.drawImage(this.staminaIcon3, canvas.width - staminaHeight - this.centreX + 5, canvas.height * 0.075, staminaHeight * 1.1, staminaHeight * 1.1)
        this.draw()
    }
}
